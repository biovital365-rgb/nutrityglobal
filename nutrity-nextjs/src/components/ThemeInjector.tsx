...
export function ThemeInjector({ plan, role }: ThemeInjectorProps) {
    useEffect(() => {
        ...
        if (isElite) {
            ...
            // Elementos de superficie un poco más oscuros para mayor elegancia
        ...
        // Cleanup function para cuando se desmonte si fuera necesario
        return () => {
