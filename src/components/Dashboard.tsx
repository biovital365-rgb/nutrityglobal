    ...
    <div className="relative w-full max-w-md h-full min-h-screen bg-[#050505] flex flex-col shadow-2xl overflow-hidden mx-auto">
      <div className="flex items-center justify-between px-6 pt-12 pb-4 bg-black/40 backdrop-blur-md z-10 sticky top-0 border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-teal/10 flex items-center justify-center border border-teal/20 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-6 pb-24 no-scrollbar">
        <div className="mb-8 mt-6 relative overflow-hidden rounded-[2rem] glass-panel p-8 border border-white/10 shadow-2xl">
          <div className="absolute top-0 right-0 w-32 h-32 bg-teal/10 rounded-full blur-[60px] pointer-events-none"></div>
          ...
          <div className="flex flex-col items-center text-center gap-4 relative z-10">
            <div className="relative w-28 h-28 flex items-center justify-center">
              <div className="absolute inset-0 border-2 border-dashed border-teal/30 rounded-full animate-[spin_30s_linear_infinite]"></div>
              <div className="absolute inset-4 border border-cyan/20 rounded-full animate-[spin_20s_linear_infinite_reverse]"></div>
              <img src="/logo.png" alt="Mandalapp" className="relative z-10 w-16 h-16 object-contain drop-shadow-[0_0_20px_rgba(20,184,166,0.5)]" />
            </div>
            <div>
            ...
            <div className="w-full h-1.5 bg-white/5 rounded-full overflow-hidden mt-2">
              <div className="h-full bg-gradient-to-r from-teal via-gold to-cyan w-full rounded-full shadow-[0_0_15px_rgba(20,184,166,0.4)]"></div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div
            ...
            className="glass-panel rounded-2xl p-5 flex flex-col gap-4 group relative overflow-hidden cursor-pointer hover:border-teal/40 transition-all hover:bg-teal/5 shadow-xl"
          >
            <div className="absolute top-0 right-0 p-3 opacity-5 group-hover:opacity-10 transition">
              <Heart className="w-12 h-12 text-teal" />
            </div>
            <div className="w-10 h-10 rounded-xl bg-teal/10 flex items-center justify-center text-teal border border-teal/10 group-hover:bg-teal/20 transition-colors">
        ...
        <div className="mt-8 rounded-[1.5rem] bg-gradient-to-br from-teal/10 via-gold/5 to-cyan/10 border border-white/10 p-6 flex items-start gap-4 shadow-inner">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1.5 leading-relaxed font-medium">
              La vibración <span className="text-teal font-bold">{results.essence}</span> de tu alma brilla con fuerza hoy. Aprovecha esta energía para manifestar tus deseos más profundos.
            </p>
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-0 w-full px-6 flex justify-center pointer-events-none z-30">
        <button
          ...
          className="pointer-events-auto w-full max-w-[340px] bg-gradient-to-r from-teal via-orange to-gold hover:scale-[1.02] text-white font-black py-4.5 px-6 rounded-2xl flex items-center justify-center gap-3 transition-all transform active:scale-95 shadow-[0_15px_40px_rgba(20,184,166,0.3)] border border-white/20"
        >
